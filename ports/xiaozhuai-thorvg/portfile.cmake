vcpkg_from_github(
    ...
    HEAD_REF master
    PATCHES
        001-always-link-opengles.patch
)

if(VCPKG_LIBRARY_LINKAGE STREQUAL "static")
    list(APPEND BUILD_OPTIONS -Ddefault_library=static)
else()
    list(APPEND BUILD_OPTIONS -Ddefault_library=shared)
endif()
