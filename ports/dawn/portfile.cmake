...
if (VCPKG_TARGET_IS_WINDOWS)
    ...
    set(DAWN_PKGCONFIG_DEPS "-lwebgpu_dawn -lonecore -luser32 -ldelayimp")
...
elseif (VCPKG_TARGET_IS_OSX)
    ...
    if (DAWN_ENABLE_METAL)
        set(DAWN_PKGCONFIG_DEPS "${DAWN_PKGCONFIG_DEPS} -framework IOSurface -framework Metal -framework QuartzCore -framework Cocoa -framework IOKit")
    endif()
    set(DAWN_PKGCONFIG_REQUIRES "${DAWN_ABSL_REQUIRES}")
